...
android_ndk?=$(HOME)/Library/Android/sdk/ndk/27.3.13750724
android_api?=21
android_tc=$(android_ndk)/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android$(android_api)-clang++
